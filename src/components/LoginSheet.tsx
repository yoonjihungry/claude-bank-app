  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={`absolute inset-x-0 bottom-0 mx-auto w-full max-w-[480px] rounded-t-[22px] border border-border bg-card px-6 pt-2.5 transition-transform duration-300 ease-out md:max-w-[600px] ${
          open
      ...
      >
        ...
        {/* 카카오 계속하기 — 브랜드 규정상 노란색(#FEE500, --kakao 토큰) + 근검정 글자 */}
        <button
          type="button"
          onClick={() => signIn('kakao')}
          className="mt-3 flex h-[50px] w-full items-center justify-center gap-2.5 rounded-xl bg-kakao text-sm font-semibold text-kakao-foreground transition hover:brightness-95"
        >
